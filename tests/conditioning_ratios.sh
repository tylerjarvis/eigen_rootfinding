...
do
  nohup python3 -u conditioning_ratios.py mult $precision $minseed $maxseed $alphavals> conditioning_ratios/nearby_roots/mult/"$alphavals".txt 2> conditioning_ratios/nearby_roots/mult/err"$alphavals".txt &
  echo $alphavals $! >> cond_ratios_pids.txt
done
