import numpy as np
from eigen_rootfinding.OneDimension import multPower, multCheb, divCheb, divPower
from eigen_rootfinding.polynomial import MultiCheb, MultiPower, getPoly
from eigen_rootfinding.polyroots import solve as prsolve

try:
    from eigen_rootfinding.TVBMethod import solve as TVBsolve
    TVB_avail = True
except:
    TVB_avail = False
